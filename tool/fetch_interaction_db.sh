...
POS = [("class:loop_and_thiazide_diuretics", "4603", "furosemide"),
       ...
       ("class:valproate", "266856", "divalproex sodium"),
       ("class:valproate", "9919", "sodium valproate"),
       ("class:valproate", "40254", "valproate"),
       ("class:valproate", "11118", "valproic acid"),
...
NEG = [("class:loop_and_thiazide_diuretics", "9997", "spironolactone"),
       ...
       ("class:enzyme_inducing_antiseizure_medications", "266856", "divalproex sodium"),
       ("class:enzyme_inducing_antiseizure_medications", "9919", "sodium valproate"),
       ("class:enzyme_inducing_antiseizure_medications", "11118", "valproic acid"),
