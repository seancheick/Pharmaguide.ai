...
class ProductListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final scoreLabel = score != null
        ...
        : '';
    final brandLabel = product.brandName != null
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                // Animated score ring
                PGScoreRing(score: score, size: 52, strokeWidth: 4),
...
class ProductGridItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final gridScoreLabel = score != null
        ? ', score ${score.round()} out of 100'
        : '';
    final gridBrandLabel = product.brandName != null
        ? ' by ${product.brandName}'
        : '';
    ...
    return Semantics(
      button: true,
      label:
          '${product.productName}$gridBrandLabel$gridScoreLabel. Tap to view details.',
      child: PGCard(
        onTap: () => context.push('/product/${product.dsldId}'),
