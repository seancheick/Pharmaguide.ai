...
void main() {
  group('evidence_strength_vocab.json drift contract', () {
    final file = File('assets/data/evidence_strength_vocab.json');
    ...
    test('canonical interaction-rule strength IDs present', () {
      final decoded =
          jsonDecode(file.readAsStringSync()) as Map<String, dynamic>;
      final entries = (decoded['evidence_strengths'] as List)
